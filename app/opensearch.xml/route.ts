...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
  ...
  <Description>Search ${siteConfig.name} — CNC Plate Bending, Press Brake &amp; Sheet Metal Fabrication services in Surat</Description>
  ...
  <Query role="example" searchTerms="CNC plate bending"/>
  <Developer>${siteConfig.legalName}</Developer>
  <Contact>${siteConfig.email}</Contact>
  <Tags>CNC plate bending press brake sheet metal fabrication Surat Gujarat India</Tags>
