...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    title:
      count > 0
        ? `CNC Plate Bending Gallery - ${count} Laser Cutting & Fabrication Photos | Balaji Engineering Works Surat`
        : "CNC Plate Bending Gallery - Laser Cutting & Sheet Metal Fabrication Photos | Balaji Engineering Works Surat",
    description:
      count > 0
        ? `Browse ${count} photos of CNC plate bending, laser cutting, plasma cutting, welding, sheet metal fabrication, and finished industrial products from Balaji Engineering Works in Surat, Gujarat.`
        : "Browse photos of CNC plate bending, laser cutting, plasma cutting, welding, sheet metal fabrication, and finished industrial products from Balaji Engineering Works in Surat, Gujarat.",
    path: "/gallery",
    keywords: [
